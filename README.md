...
See [the Windows setup and admin guide](docs/SETUP_AND_ADMIN_GUIDE.md) for installation, emulator/proxy configuration, the GUI, safe snapshot import/export and troubleshooting.

Launch the admin panel with `venv\Scripts\python.exe -m gui.main`.
